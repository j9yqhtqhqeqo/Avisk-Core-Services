...
PARM_LOGFILE = (r'/Users/mohanganadal/Data Company/Text Processing/Programs/DocumentProcessor/Log/DataSourceLog')
...
class DataSourceProcessor:
    ...
    def download_content_from_source_and_process_text(self):
        ...
        for document in self.document_list:
            ...
            file_name = company_name +' '+str(year)+' '+content_type_desc+'.'+source_type
            l_file_location = PARM_PDF_IN_FOLDER +'/' + str(year) +'/'+file_name
            try:
                ## Down load file to Stage 0 -- same format as provided by source url
                self.download_single_file(url=source_url,f_name=l_file_location,f_log=self.logfile)
                ...
                output_file_name = company_name +' '+str(year)+' '+content_type_desc+'.txt'
                ...
                print("Successfully downlaoded and processed file:"+output_file_name)
        ...
        self.datasourceDBMgr.add_stage1_processed_files_to_t_document(processed_documents)
