...
class StartUpClass:
    ...
    def create_competitor_analysis(self):
        ...
        if (not no_company_data and not no_competitor_data):
            ...
            ds2 = self.company_dataset[["ESG_Category", "Exposure_Pathway", "Internalization", "Score"]].sort_values(
            ...
            ds = self.competitor_dataset[["ESG_Category", "Exposure_Pathway", "Internalization", "Score"]].sort_values(
                'Score', ascending=False).head(10)
    ...
    def create_company_sector_analysis(self):
        ...
        if (not self.company_dataset.empty):
            ...
            ds = self.sector_dataset[["ESG_Category", "Exposure_Pathway", "Internalization", "Score"]].sort_values(
                'Score', ascending=False).head(10)
            ds["Rank"] = ds["Score"].rank(ascending=False, method='first')
            self.draw_AG_Grid(
                ds[["Rank", "ESG_Category", "Exposure_Pathway", "Internalization"]], key='int_sector1')
