...
class StartUpClass:
    ...
    def run_online_Mode(self):
        ...
        if(pending_documents_exp == 0):
            st.text('No New Documents to Process:Awaiting Batch Process Scheduling for Exposure Pathway')
        else:
        ...
        if(pending_documents_int == 0):
            st.text('No New Documents to Process:Awaiting Batch Process Scheduling for Internalization')
        else:
        ...
        if(pending_documents_mit == 0):
            st.text('No New Documents to Process:Awaiting Batch Process Scheduling for Mitigation')
        else:
        ...
        if(pending_documents_mit == 0):
            st.text('No New Documents to Process:Awaiting Batch Process Scheduling for Exposure Insight Generation')
        else:
        ...
        if(pending_documents_mit == 0):
            st.text('No New Documents to Process:Awaiting Batch Process Scheduling for Internalization Insight Generation')
        else:
        ...
        if(pending_documents_mit == 0):
            st.text('No New Documents to Process:Awaiting Batch Process Scheduling for Exposure ->Internalization Insight Generation')
        else:
        ...
        if(pending_documents_mit == 0):
            st.text('No New Documents to Process:Awaiting Batch Process Scheduling for Exposure ->Mitigation Insight Generation')
        else:
        ...
        if(pending_documents_mit == 0):
            st.text('No New Documents to Process:Awaiting Batch Process Scheduling for Internalization ->Mitigation Insight Generation')
        else:
        ...
        if(pending_documents_mit == 0):
            st.text('No New Documents to Process:Awaiting Batch Process Scheduling for Exposure ->Internalization ->Mitigation Insight Generation')
        else:
