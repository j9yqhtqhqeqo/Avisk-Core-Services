...
class StartUpClass:
    ...
    def __init__(self) -> None:
        ...
        # print('ESG Insights.ai - Vesion 1.0, Build Date:06/11/2023 9:22 AM')
        # Global Variables
        self.exposure_list = []
    ...
    def create_tabs(self):
        ...
        tab_titles = ['Top 10 Exposures', 'Triangles',
                      'YOY Exposure', 'Exposure Vs. Control']
    ...
    def draw_top10_exposure_plot(self):
        ...
        ax.plot([0.0, 30], [list_length+0.4, list_length+0.4],
                lw='.5', c='black')
        ...
        for d in self.exposure_list:
            ...
            ax.text(x=12, y=row, s=round(comp_score, 2),
                    va='center', ha='right')
    ...
    def draw_triangle_charts(self):
        ...
        if (not self.triangle_dataset is None and len(self.triangle_dataset) > 0):
            ...
            categories = ['Exposure - Internalization',
                          'Exposure-Mitigation', 'Internalization-Mitigation']
